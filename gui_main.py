...
from PyQt5.QtWidgets import QVBoxLayout, QGridLayout, QCheckBox, QHBoxLayout
from maps.map_manager import get_map_names
...
class UiMain(QtWidgets.QWidget):
    ...
    def parameters_Ui(self, dimensions) -> None:
        ...
        options_layout.addWidget(self.starting_map_label, 3, 0)
